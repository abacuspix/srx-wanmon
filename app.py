...
from srx_wanmon_utils import if_fw_state, ifstats, routeFinder, ns
...
def collectStats (devices):
    ...
    device_stats["prime_if_fw_state_count"] = if_fw_state(d , "gr-0/0/0.0")

    device_stats["alt_if_fw_state_count"] = if_fw_state(d , "st0.0")
